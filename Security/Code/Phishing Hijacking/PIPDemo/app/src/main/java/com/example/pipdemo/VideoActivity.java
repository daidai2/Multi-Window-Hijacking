        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(canUsageStats(getApplicationContext())) {
                    //开启监听Service
                    Intent monitor = new Intent(VideoActivity.this, MonitorService.class);
                    monitor.putExtra("time",video.getCurrentPosition());
                    startService(monitor);
                    //开启PIP
                    Intent pip = new Intent(VideoActivity.this, VideoActivity.class);
                    pip.putExtra("flag", true);
                    pip.putExtra("time",video.getCurrentPosition());
                    startActivity(pip);
                }else{
                    //申请权限
