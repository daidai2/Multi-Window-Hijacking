package com.example.exitffstack;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int POSTDELAYED_COUNTS = 1000;    //监听时间间隔
    ...
    public void openWeb(){
        ...
        finish();                         //主栈开启的关键
        //打开浏览器，跳转至网址
        String xunLei_Website = "https://auth.alipay.com/login/index.htm?needTransfer=true&goto=http://memberprod.alipay.com/account/reg/index.htm";    //迅雷云盘网址
        jumpUriToBrowser(getApplicationContext(), xunLei_Website);
        Intent intent = new Intent(MainActivity.this,MainActivity.class);
//        ComponentName componetName = new ComponentName(
//                //这个是另外一个应用程序的包名
//                "com.example.pippishing",
//                //这个参数是要启动的Activity
//                "com.example.pippishing.MainActivity");
